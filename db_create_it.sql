...
CREATE TABLE spaces_photo (
    id_space__Photo INT AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE extras (
	...
	price SMALLINT UNSIGNED NOT NULL,
    CONSTRAINT fk_extra_space FOREIGN KEY (id_space) REFERENCES spaces (id_space)
);
...
CREATE TABLE incidents (
    ...
    CONSTRAINT fk_incident_user FOREIGN KEY (id_user) REFERENCES users (id_user) ON DELETE CASCADE,
    CONSTRAINT fk_incident_booking FOREIGN KEY (id_booking) REFERENCES bookings (id_booking) ON DELETE CASCADE
);
CREATE TABLE reviews (
    ...
    CONSTRAINT fk_review_user FOREIGN KEY (id_user) REFERENCES users (id_user) ON DELETE CASCADE,
    CONSTRAINT fk_review_booking FOREIGN KEY (id_booking) REFERENCES bookings (id_booking) ON DELETE CASCADE
);
